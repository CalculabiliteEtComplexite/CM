...
\begin{frame}{Complexité d'un problème}
  ...
  \begin{block}{Classes de complexité d'un problème}
    Soit $f : \mathbb{N} \rightarrow \mathbb{N}$ une fonction. 
  ...
  \begin{block}{Classes de complexité importantes}
    ...
    \begin{tikzpicture}[y=4mm, x=21mm]
      ...
      \node[align=right,  left ] at (0,1) {Complexité\\[-2pt]\structure{temporelle}};
      \node[align=right,  left ] at (0,3) {Complexité\\[-2pt]\structure{spatiale}};
    \end{tikzpicture}
