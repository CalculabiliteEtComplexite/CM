...
\begin{frame}{Configurations d'une machine de Turing}
  ...
  \onBlock[top=-3mm]{Définition -- Configuration d'une machine de Turing}{
  ...
  \onExampleBlock[y=-20mm]{Exemple -- La configuration {\color{black}$\langle \structure{ba},\alert{1},\example{ab}\rangle \simeq \langle\blank\structure{ba},\alert{1},\example{ab}\blank\rangle $}}{}
