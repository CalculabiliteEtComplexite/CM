...
\begin{frame}{Tout langage reconnaissable est généré}

  \onBlock[top=-5mm]{Théorème}{
    Tout langage reconnaissable est généré par une MTND.
  }

  \onBlock[y=10mm]{Démonstration -- Force brute ascendante non-déterministe}{
    Soit \alert{$M=\langle \Sigma, \Gamma, \blank, Q, q_0, F, \rightarrow \rangle$} une MTND. $\mathcal{L}(M)$ est généré par :
    
    \begin{algorithm}[H]\small
      \Fun{$\Generer_{\mathcal{L}(M)}()$}{
        \While{$\exists \alert{\alpha \rightarrow \beta}, \exists \structure{x}, \structure{y} \in (\Sigma \cup \Gamma)^\star,~ u = \structure{x} \alert{\beta} \structure{y}$}{
