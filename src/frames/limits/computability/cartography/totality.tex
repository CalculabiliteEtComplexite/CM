...
\begin{frame}{Totalité d'un langage algébrique}
  ...
  \onAlertBlock[bottom=3mm]{Remarque -- restriction aux langages déterministes}{
    \begin{itemize}
    \item \textsc{Totality-Alg} est \alert{indécidable} pour les automates à pile \alert{non-déterministe}
    \item \textsc{Totality-Alg} est \alert{décidable} pour les automates à pile \alert{déterministe}
    \end{itemize}
  }
