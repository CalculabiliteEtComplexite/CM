      ...
      \scalebox{.75}{
        \begin{tikzpicture}
          ...
          \begin{scope}
            ...
            \begin{scope}
              \clip (3,0) rectangle (7,1);
              \fill[structure!50] (3,0) rectangle (7,1);
            ...
            \begin{scope}
              \clip (3,0) rectangle (7,-1);
              \fill[example!50] (3,0) rectangle (7,-1);
          ...
          \path[-latex, thick] (1.9,.35)  edge[bend left]  node[below]{$f$}         (4.15,.25) ; 
          \path[-latex, thick] (6.9,.35)  edge[bend left]  node[below]{$g$}         (8.92,.4) ; 
          \path[-latex, thick] (1.9,-.35) edge[bend right] node[above]{$g \circ f$} (9.55,-.25) ; 
        \end{tikzpicture}
      }
    \end{center}
  \end{block}
