...
\begin{frame}{Difficulté du problème universel}
  ...
  \begin{block}{Théorème -- \textsc{re}-complétude de \textsc{Universal}}
    \vspace{-1mm}
    Pour tout langage de programmation $\langle \mathcal{L}, \llbracket \cdot \rrbracket \rangle$, \alert{$\textsc{Universal}_{\langle \mathcal{L}, \llbracket \cdot \rrbracket \rangle}$ est \textsc{re}-complet}. 
