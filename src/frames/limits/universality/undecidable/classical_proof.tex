...
\begin{frame}{L'argument par diagonalisation de Turing}
  ...
  \onBlock[text,top=-3mm]{Les langages universels sont indécidables}{
    ...
    \begin{itemize}
    \item Soit $\langle \mathcal{L}, \llbracket \cdot \rrbracket \rangle$ un langage de programmation.
  ...
  \onBlock<3->[bottom]{Remarque : c'est encore le paradoxe du barbier}{
    ...
    \end{itemize}
    $$\alert{\nexists \Diagonale, \forall u, u\in \llbracket \Diagonale \rrbracket \Leftrightarrow \Diagonale \notin \llbracket \Diagonale \rrbracket}$$
    \begin{itemize}
